...
project = 'molecool'
copyright = ("2020, James Varner. Project structure based on the "
...
texinfo_documents = [
    (master_doc, 'molecool', 'molecool Documentation',
     author, 'molecool', 'A Python package for analyzing and visualizing pdg and xyz files. For <olssi May webinar series.',
     'Miscellaneous'),
]
